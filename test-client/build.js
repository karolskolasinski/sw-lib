(() => {
  ...
  // src/sw-text-input/sw-number-input.style.css
  ...
  // src/sw-text-input/sw-number-input.jsx
  ...
  // src/sw-utils/sw-flash-message/sw-modal.style.css
  ...
  // src/sw-utils/sw-flash-message/sw-modal.jsx
