...
`);
  ...
  var SwSelect = class extends _ {
    constructor() {
      super();
      this.state = { selectedOption: "Please select an option \u25BC" };
    ...
    render({ config: { name, sourceFn, labelField, initialOptions, minimumCharLengthTrigger } = {} }) {
      const options = this.state.options ? this.state.options : initialOptions;
      if (!name || !options)
        throw new Error('Missing "name" or "options" parameter.');
      if (!sourceFn)
      ...
      }, this.state.selectedOption), /* @__PURE__ */ v("div", {
        className: `dropdown
  ...
  var Main = class extends _ {
    ...
    render() {
      return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("sw-select", {
        config: {
          name: "test",
