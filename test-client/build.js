(() => {
  ...
  var SwNumberInput = class extends _ {
    render({ name, required, placeholder, disabled, value, min, max, step }) {
      return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("style", null, sw_number_input_style_default), /* @__PURE__ */ v("div", {
