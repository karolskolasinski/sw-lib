...
function update2(state, msg2) {
  if (msg2.type === "attr" && typeof msg2.value === "string") {
    state.count = parseInt(msg2.value, 10);
  } else if (msg2.type === "attr" && typeof msg2.value === "number") {
    state.count = msg2.value;
  }
  return [state, null];
}
function view9(state) {
  return /* @__PURE__ */ v("p", null, "Current count: ", state.count);
}
