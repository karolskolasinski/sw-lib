...
var __spreadValues2 = (a3, b22) => {
  for (var prop in b22 || (b22 = {}))
    if (__hasOwnProp2.call(b22, prop))
      __defNormalProp2(a3, prop, b22[prop]);
  if (__getOwnPropSymbols2)
    for (var prop of __getOwnPropSymbols2(b22)) {
      if (__propIsEnum2.call(b22, prop))
        __defNormalProp2(a3, prop, b22[prop]);
    }
  return a3;
};
var __spreadProps2 = (a3, b22) => __defProps2(a3, __getOwnPropDescs2(b22));
...
tr.addTranslation = function(phrase, translation) {
  (0, import_set.default)(window, ["tr", "translations", phrase], __spreadValues2(__spreadValues2({}, (0, import_get.default)(window, ["tr", "translations", phrase], {})), translation));
};
...
var InitializationState = class {
  ...
  getValues() {
    return __spreadValues2({}, this.values);
  }
};
...
function component({
  ...
  function runUpdate(cmp, msg2) {
    requestAnimationFrame(() => {
      ...
      const updateResult = update2((0, import_cloneDeep.default)(getState(cmp)), msg2);
...
function getRouteParams(route) {
  ...
  for (let i3 = 0; i3 < route.parts.length; i3 += 1) {
    ...
    params = __spreadValues2(__spreadValues2({}, params), part.paramsObjectFromUrlPart(pathSplit[i3]));
  }
  return params;
}
...
function addRoute(routeDef) {
  ...
  routes.push(__spreadProps2(__spreadValues2({}, routeDef), { parts }));
}
...
function update(state, msg2) {
  ...
  if (state instanceof InitializationState) {
    ...
    let newState = __spreadValues2({}, state);
    switch (msg2.name) {
      case "numberOfPages":
...
function pageView(state, page, inner, className = "") {
  return ["a", {
    href: router.getRouteUrl(state.routeName, __spreadProps2(__spreadValues2({}, state.routeParams), { page })),
...
((flashMessage2) => {
  ...
  function disableDefaultStyles() {
    window.flashMessage = __spreadProps2(__spreadValues2({}, window.flashMessage || {}), {
      defaultStyles: false
    });
  }
...
component({
  ...
  update(state, msg2) {
    return (0, import_ts_pattern.match)([state, msg2]).with([import_ts_pattern.__, ["AttributeChange", "config", (0, import_ts_pattern.select)()]], (config) => {
      var _a2;
      return [
        __spreadProps2(__spreadValues2({}, config), {
      ...
      __spreadProps2(__spreadValues2({}, state), { isDropdownVisible: true, isLoading: false }),
      focus(".input")
    ]).with([import_ts_pattern.__, ["KeyboardMove", "Escape"]], () => [__spreadProps2(__spreadValues2({}, state), { isDropdownVisible: false }), null]).with([import_ts_pattern.__, ["KeyboardMove", import_ts_pattern.__]], () => [state, null]).with([import_ts_pattern.__, "CloseSelect"], () => [
      __spreadProps2(__spreadValues2({}, state), { isDropdownVisible: false, isLoading: false }),
      null
    ]).with([import_ts_pattern.__, "ToggleSelect"], () => [
      __spreadProps2(__spreadValues2({}, state), { isDropdownVisible: !state.isDropdownVisible, isLoading: false }),
      focus(".input")
    ]).with([import_ts_pattern.__, ["Pick", (0, import_ts_pattern.select)()]], (option) => [
      __spreadProps2(__spreadValues2({}, state), { isLoading: false, isDropdownVisible: false, selected: option }),
      ...
      __spreadProps2(__spreadValues2({}, state), { isLoading: true, displayedOptions: options }),
      null
    ]).with([import_ts_pattern.__, "SearchFailure"], () => {
      flashMessage(tr("select.searchFailed"), "error");
      return [__spreadProps2(__spreadValues2({}, state), { isLoading: false }), null];
      ...
      if (state.minimumCharLengthTrigger > phrase.length) {
        return [__spreadProps2(__spreadValues2({}, state), { phrase }), null];
      }
      return [__spreadProps2(__spreadValues2({}, state), { phrase }), delaySearch(phrase)];
      ...
      return [
        __spreadProps2(__spreadValues2({}, state), {
          phrase,
      ...
      if (state.phrase === phrase) {
        return [__spreadProps2(__spreadValues2({}, state), { isLoading: true }), search(state)];
      } else {
        return [state, null];
      }
    }).run();
...
component({
  ...
  update(state, msg2) {
    return (0, import_ts_pattern3.match)(msg2).with(["AttributeChange", "type", (0, import_ts_pattern3.select)()], (inputValue) => {
      ...
      __spreadProps2(__spreadValues2({}, state), { value }),
      new CustomEvent("update", {
        bubbles: true,
        detail: {
          name: state.name,
...
component({
  ...
  update(state, msg2) {
    return (0, import_ts_pattern5.match)(msg2).with(["AttributeChange", "isDisabled", (0, import_ts_pattern5.select)()], (isDisabled) => [__spreadProps2(__spreadValues2({}, state), { isDisabled: !!isDisabled }), null]).with(["AttributeChange", "href", (0, import_ts_pattern5.select)()], (href) => [__spreadProps2(__spreadValues2({}, state), { href }), null]).with(["AttributeChange", "children", (0, import_ts_pattern5.select)()], (children) => [__spreadProps2(__spreadValues2({}, state), { children }), null]).with(["AttributeChange", import_ts_pattern5.__, import_ts_pattern5.__], () => [state, null]).exhaustive();
  },
  view(state) {
...
component({
  ...
  update(state, msg2) {
    return (0, import_ts_pattern6.match)(msg2).with(["AttributeChange", "disabled", (0, import_ts_pattern6.select)()], (disabled) => [
      __spreadProps2(__spreadValues2({}, state), { disabled: attrToBool(disabled) }),
      null
      ...
      __spreadProps2(__spreadValues2({}, state), { placeholder }),
      null
    ]).with(["AttributeChange", "showLabel", (0, import_ts_pattern6.select)()], (showLabel) => [
      __spreadProps2(__spreadValues2({}, state), { showLabel: attrToBool(showLabel) }),
      null
    ]).with(["AttributeChange", "name", (0, import_ts_pattern6.select)()], (name) => [
      __spreadProps2(__spreadValues2({}, state), { name }),
      null
...
component({
  ...
  update(state, incomingMsg) {
    return (0, import_ts_pattern7.match)(incomingMsg).with(["AttributeChange", "disabled", (0, import_ts_pattern7.select)()], (disabled) => {
      return [__spreadProps2(__spreadValues2({}, state), { disabled: !!disabled && disabled !== "false" }), null];
    }).with(["AttributeChange", "name", (0, import_ts_pattern7.select)()], (name) => {
      return [__spreadProps2(__spreadValues2({}, state), { name: name.toString() }), null];
    }).with(["AttributeChange", "value", (0, import_ts_pattern7.select)()], (value) => {
      return [__spreadProps2(__spreadValues2({}, state), { value: value.toString() }), null];
    }).with(["AttributeChange", "class", (0, import_ts_pattern7.select)()], (className) => {
      return [__spreadProps2(__spreadValues2({}, state), { className: className.toString() }), null];
    }).with(["AttributeChange", "placeholder", (0, import_ts_pattern7.select)()], (placeholder) => {
      return [__spreadProps2(__spreadValues2({}, state), { placeholder: placeholder.toString() }), null];
    }).with(["AttributeChange", "suggestions", (0, import_ts_pattern7.select)()], (suggestions) => {
      return [__spreadProps2(__spreadValues2({}, state), { suggestions }), null];
      ...
      __spreadProps2(__spreadValues2({}, state), { suggestions: [] }),
      null
...
state_mgr_exports.component({
  ...
  update(state, msg2) {
    if (msg2.type === "introduce") {
      return [
        __spreadProps(__spreadValues({}, state), { display: "question" }),
        null
      ];
    }
    if (msg2.type === "input") {
      return [
        __spreadProps(__spreadValues({}, state), { name: msg2.name }),
        null
      ];
    }
    if (msg2.type === "confirmName") {
      return [
        __spreadProps(__spreadValues({}, state), { display: "welcoming" }),
        null
      ];
    }
    return [state, null];
...
function view9(state) {
  if (state.display === "idle") {
    return /* @__PURE__ */ v("button", {
      onClick: { type: "introduce" }
    }, "Introduce yourself");
  }
  if (state.display === "question") {
    return /* @__PURE__ */ v("div", null, /* @__PURE__ */ v("input", {
      type: "text",
      onInput: (event) => ({ type: "input", name: event.target.value })
    }), /* @__PURE__ */ v("button", {
      onClick: { type: "confirmName" }
    }, "OK"));
  }
  return /* @__PURE__ */ v("p", null, "Hello ", state.name, "!");
}
