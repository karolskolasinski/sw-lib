...
function update2(state, msg2) {
  if (msg2.type === "attr" && typeof msg2.value === "string") {
    state.query = msg2.value;
    state.isLoading = true;
    state.hasLoadError = false;
    return [state, loadUsers(msg2.value)];
  }
  ...
  if (msg2.type === "loadSuccess") {
    state.hasLoadError = false;
    state.isLoading = false;
    state.users = msg2.users;
    return [state, null];
  }
  return [state, null];
}
...
function view9(state) {
  return /* @__PURE__ */ v("div", {
    class: "gh-users"
  }, /* @__PURE__ */ v("h2", null, "Github Users search for phrase: ", state.query), state.isLoading && /* @__PURE__ */ v("div", {
    class: "loader"
  }, "loading..."), state.hasLoadError && /* @__PURE__ */ v("div", {
    class: "danger"
  }, "Error occured"), "found:", /* @__PURE__ */ v("ul", null, /* @__PURE__ */ v(d, null, state.users.map((user) => /* @__PURE__ */ v("li", null, user.login)))));
}
